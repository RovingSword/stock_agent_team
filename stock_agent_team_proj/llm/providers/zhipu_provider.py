...
class ZhipuProvider(BaseLLMProvider):
    ...
    def _load_config_from_env(self) -> LLMConfig:
        ...
        return LLMConfig(
            ...
            max_tokens=int(os.environ.get("ZHIPU_MAX_TOKENS", "2000")),
            timeout=int(os.environ.get("ZHIPU_TIMEOUT", "60")),
            max_retries=int(os.environ.get("ZHIPU_MAX_RETRIES", "3")),
        )
    ...
    def _do_chat(
        ...
        **kwargs
        ...
        def _request():
            ...
            logger.debug(f"发送请求到智谱AI: {params['model']}")
    ...
    def _chat_stream_impl(
        ...
        **kwargs
        ...
        logger.debug(f"发送流式请求到智谱AI: {params['model']}")
